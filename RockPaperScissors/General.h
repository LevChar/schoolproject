...
enum reasons { ALL_FLAGS_OF_THE_OPPONENT_ARE_CAPTURED, ALL_MOVING_PIECES_OF_THE_OPPONENT_ARE_EATEN, A_TIE_BOTH_MOVES_INPUT_FILES_DONE_WITHOUT_A_WINNER,BAD_POSITIONING_INPUT_FILE_FOR_PLAYER_LINE, BAD_POSITIONING_INPUT_FOR_BOTH_PLAYERS };
enum afterMoveWasSentIssues {
	HEY_ALL_IS_FINE, HEY_THIS_IS_NOT_YOUR_PIECE,
